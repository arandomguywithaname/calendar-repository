(function () {
  var GAME_ID = "math-division-drill";
  ...
  function nextProblem() {
    ...
    // pick divisor and quotient first, multiply to get dividend so it always divides evenly.
    var divisor = window.ArcadeCommon.randInt(1, max);
    var quotient = window.ArcadeCommon.randInt(1, max);
